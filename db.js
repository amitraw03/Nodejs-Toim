...
const mongoURL =  process.env.MONGODB_URL_LOCAL; // 'hotels' here is the db name  ---local D.B Server
// const mongoURL = process.env.MONGODB_URL; // 'hotels' here is the db name      ---Global D.B Server
